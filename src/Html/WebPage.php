...
HTML;
     ...
     *
     * @link https://www.php.net/manual/fr/function.getlastmod.php
     * @link https://www.php.net/manual/fr/class.datetime.php
     * @link https://www.php.net/manual/fr/intldateformatter.formatobject.php
